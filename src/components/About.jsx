...
const focus = [
  { icon: <FiTerminal size={18} />, label: 'Full Stack Development with AI', desc: 'End-to-end apps & AI workflows' },
]
      ...
      <div className="section-container">
        ...
        >
          <motion.div
            ...
            className="group flex items-center gap-3 px-4 sm:px-5 py-3 rounded-xl border border-overlay/[0.04] 
                       bg-overlay/[0.02] hover:border-accent/20 hover:bg-overlay/[0.04] transition-all duration-300 w-fit"
          >
            ...
            {highlights.map((h, i) => (
              ...
              >
                <span className="text-2xl sm:text-3xl lg:text-4xl font-bold gradient-text">
                  <CountUp value={h.value} start={isInView} />
                </span>
