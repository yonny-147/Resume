  ...
  return (
    ...
    <div className='containerHome'>
      <div className='curriculumGene'>  
          <p className='myName'>I'm <span className='name'>Yonny</span></p>
          <br />
          <p>I'm a Full Stack web Developer with skills in HTML, CSS, JavaScript, React Js, Node Js, Exrpress, PHP, laravel. My job is to create attractive and functional user interfaces for web applications. I collaborate closely with designers and other developers to ensure a high-quality user experience. I am always up to date on the latest technologies to improve the performance of web applications.</p>
